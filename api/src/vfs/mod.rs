...
// pub use proc::new_procfs; // [ondemand-procfs] commented out: procfs is statically mounted again
...
pub fn mount_all() -> LinuxResult<()> {
    ...
    // [ondemand-procfs] commented out: init_kallsyms is no longer needed for static procfs
